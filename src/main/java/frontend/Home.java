...
public class Home extends javax.swing.JFrame {
    ...
    public void receber(PessoaFisica pessoa){
        this.pessoa = pessoa;
        initComponents(); // Os componentes são criados aqui

        // --- ADICIONE ESTAS LINHAS AQUI ---
        // Configura os nomes internos para o AssertJ Swing encontrar os botões
        jButton1.setName("botaoMeusRemedios");
        jButton2.setName("botaoContatosMedicos");
        jButton3.setName("botaoContatosFarmacias");
        nome_home1.setName("labelNomeUsuario");
    }
